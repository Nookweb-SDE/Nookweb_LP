...
export const CASE_PREVIEWS: CasePreviewMap = {
  ...
  n8n: [
    {
      id: "n8n-a",
      clientName: "N8N Cases",
      clientTagline: "Fluxo de BaaS com certificado",
      template: "dashboard",
    ...
    },
    {
      id: "n8n-b",
      clientName: "N8N Cases",
      clientTagline: "Automação ETL de carga diária",
      template: "dashboard",
      palette: { bg: "#101317", accent: "#FF4500", accentSoft: "rgba(255,69,0,0.12)", text: "#F9FAFB", textMuted: "#9CA3AF", card: "#111827", border: "rgba(255,255,255,0.08)" },
      sections: [],
    },
    {
      id: "n8n-c",
      clientName: "N8N Cases",
      clientTagline: "Fluxo de automação de blog com IA",
      template: "dashboard",
      palette: { bg: "#101317", accent: "#FF4500", accentSoft: "rgba(255,69,0,0.12)", text: "#F9FAFB", textMuted: "#9CA3AF", card: "#111827", border: "rgba(255,255,255,0.08)" },
      sections: [],
    },
