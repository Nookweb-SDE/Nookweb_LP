    ...
    <main className="pt-20 sm:pt-24 pb-16 sm:pb-24">
      <Container>
        <article className="max-w-3xl w-full prose prose-neutral overflow-x-hidden">
          <h1 className="font-serif text-2xl sm:text-3xl md:text-4xl">Política de Privacidade</h1>
          ...
          <h2 className="font-serif text-xl sm:text-2xl mt-6 sm:mt-8">Coleta de Dados</h2>
          ...
          <h2 className="font-serif text-xl sm:text-2xl mt-6 sm:mt-8">Uso dos Dados</h2>
          <p className="text-neutral">
            Utilizamos seus dados exclusivamente para contato comercial e para melhorar nossos serviços.
          </p>
          <h2 className="font-serif text-xl sm:text-2xl mt-6 sm:mt-8">Seus Direitos</h2>
          <p className="text-neutral">
