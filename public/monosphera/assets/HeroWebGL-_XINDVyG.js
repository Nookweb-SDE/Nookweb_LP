import{j as t,ap as m,r as n,aq as u,ar as l,as as p,at as x,au as d,av as f}from"./index-CdEDNG_G.js";d(f);function y(){const s=n.useRef(null),o=n.useRef(null),{geometry:c,shaderArgs:v}=n.useMemo(()=>{const e=new u(12,12,128,128),a={uniforms:{uTime:{value:0},uStrength:{value:1.5},uColor1:{value:new l("#00d4ff")},uColor2:{value:new l("#0a0e14")},uColor3:{value:new l("#8B5CF6")}},vertexShader:`
      uniform float uTime;
